...
export class Backend implements backendInterface {
    ...
    async getAllMods(): Promise<Array<PublicModData>> {
        if (this.processError) {
            try {
    ...
    async saveMod(arg0: string, arg1: string, arg2: Array<string>, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMod(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
